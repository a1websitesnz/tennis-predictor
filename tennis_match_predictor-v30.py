...
# ✅ Only rename columns if data is loaded and required columns exist
if not kaggle_df.empty:
    ...
    available_rename_map = {k: v for k, v in rename_map.items() if k in kaggle_df.columns}
    kaggle_df.rename(columns=available_rename_map, inplace=True)
