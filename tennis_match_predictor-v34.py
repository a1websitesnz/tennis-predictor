...
# Match short names with top 300
players = [p for p in all_players if any(p.split()[0] in full and p.split()[-1] in full for full in top_300_names)]

# Fallback if mapping returns nothing
if not players:
    players = all_players
