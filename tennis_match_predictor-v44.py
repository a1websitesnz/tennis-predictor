...
# Allow matching formats like "Alcaraz C." or "Carlos Alcaraz"
current_players = set()
for full_name in manual_top_300_names:
    last_first = normalize_name(full_name)
    current_players.add(last_first)
...
players = [p for p in all_players if normalize_name(p) in current_players]
