...
if os.path.exists(ranking_file):
    ...
    player_id_name_map["full_name"] = player_id_name_map["full_name"].str.strip()
    ...
    top_300_names = list(merged.sort_values("rank")["full_name"].unique())
