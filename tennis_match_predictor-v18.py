...
if os.path.exists(ranking_file):
    ...
    player_id_name_map["first_name"] = player_id_name_map["first_name"].fillna("").astype(str)
    player_id_name_map["last_name"] = player_id_name_map["last_name"].fillna("").astype(str)
